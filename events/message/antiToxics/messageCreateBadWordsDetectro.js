...
module.exports = {
    ...
    async execute(message) {
        ...
        const blacklistedWords = ['test'];

        if (blacklistedWords.some(word => message.content.toLowerCase().includes(word))) {
            message.delete();
            return message.channel.send({ content: 'You can\'t say that omg'});
        }
