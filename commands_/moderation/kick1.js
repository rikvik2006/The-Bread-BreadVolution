module.exports = {
    ...
    callback: ({ message, interaction, args }) => {
        const target = message ? message.mention.members.frist() : interaction.options.getMember("user")
        ...
        const no_target = new Discord.MessageEmbed()
            ...
            .setFooter("Usege: !!kick @user <reason>", interaction.client.user.avatarURL())
